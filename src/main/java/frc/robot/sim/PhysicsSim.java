...
public class PhysicsSim {
     ...
     */
    public void addTalonFX(TalonFX Krakenx60FX, final double rotorInertia) {
        if (Krakenx60FX != null) {
            TalonFXSimProfile simKrakenx60FX = new TalonFXSimProfile(Krakenx60FX, rotorInertia);
            _simProfiles.add(simKrakenx60FX);
        }
    }
